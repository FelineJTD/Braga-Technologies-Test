...
function Navbar() {
  ...
  return (
    <nav className="flex bg-white bg-opacity-80 backdrop-blur-md rounded-md border-black py-4 px-6 border-2 fixed top-6 w-[90%] 2xl:w-[80%] mx-[5%] 2xl:mx-[10%] justify-between z-50">
